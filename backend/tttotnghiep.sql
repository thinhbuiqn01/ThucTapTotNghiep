...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 18, 2023 lúc 03:41 PM
...
(5, '2023_03_18_140600_table_groups', 1),
(6, '2023_03_18_140618_table_products', 1),
(7, '2023_03_18_140700_table_orders', 1),
(8, '2023_03_18_140725_table_posts', 1),
(9, '2023_03_18_140736_table_comments', 1),
(10, '2023_03_18_140749_table_likes', 1),
...
(43, '2023_03_18_141323_create_posts_table', 2),
(44, '2023_03_18_141555_create_groups_table', 2),
(45, '2023_03_18_142205_create_categories_table', 3),
(46, '2023_03_18_142250_create_bills_table', 4),
(47, '2023_03_18_142436_create_bill_details_table', 5);
...
CREATE TABLE `products` (
  ...
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `qty` int(11) NOT NULL,
  `img01` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `img02` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
